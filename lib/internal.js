...
function intervalFromMs(ms, target) {
	target = target || {};
	var res = {
		years: intervalFromMsPeelOff(MS_IN_YEAR),
		days: intervalFromMsPeelOff(MS_IN_DAY),
		hours: intervalFromMsPeelOff(MS_IN_HOUR),
		minutes: intervalFromMsPeelOff(MS_IN_MINUTE),
		seconds: intervalFromMsPeelOff(MS_IN_SECOND),
		milliseconds: ms
	};
	...
	function intervalFromMsPeelOff(val) {
